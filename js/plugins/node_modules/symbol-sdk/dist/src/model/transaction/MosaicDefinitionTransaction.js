...
exports.MosaicDefinitionTransaction = void 0;
...
class MosaicDefinitionTransaction extends Transaction_1.Transaction {
    ...
    static createFromPayload(payload, isEmbedded = false) {
        ...
        const transaction = MosaicDefinitionTransaction.create(isEmbedded
            ...
            : Deadline_1.Deadline.createFromDTO(builder.getDeadline().timestamp), MosaicNonce_1.MosaicNonce.createFromUint8Array(builder.getNonce().serialize()), new MosaicId_1.MosaicId(builder.getId().mosaicId), MosaicFlags_1.MosaicFlags.create(builder.getFlags().indexOf(catbuffer_typescript_1.MosaicFlagsDto.SUPPLY_MUTABLE) > -1, builder.getFlags().indexOf(catbuffer_typescript_1.MosaicFlagsDto.TRANSFERABLE) > -1, builder.getFlags().indexOf(catbuffer_typescript_1.MosaicFlagsDto.RESTRICTABLE) > -1), builder.getDivisibility(), new UInt64_1.UInt64(builder.getDuration().blockDuration), networkType, isEmbedded ? new UInt64_1.UInt64([0, 0]) : new UInt64_1.UInt64(builder.fee.amount), signature, signerPublicKey.match(`^[0]+$`) ? undefined : PublicAccount_1.PublicAccount.createFromPublicKey(signerPublicKey, networkType));
     ...
     */
    createBuilder() {
        return new catbuffer_typescript_1.MosaicDefinitionTransactionBuilder(this.getSignatureAsBuilder(), this.getSignerAsBuilder(), this.versionToDTO(), this.networkType.valueOf(), TransactionType_1.TransactionType.MOSAIC_DEFINITION.valueOf(), new catbuffer_typescript_1.AmountDto(this.maxFee.toDTO()), new catbuffer_typescript_1.TimestampDto(this.deadline.toDTO()), this.mosaicId.toBuilder(), new catbuffer_typescript_1.BlockDurationDto(this.duration.toDTO()), new catbuffer_typescript_1.MosaicNonceDto(this.getMosaicNonceIntValue()), catbuffer_typescript_1.GeneratorUtils.toFlags(catbuffer_typescript_1.MosaicFlagsDto, this.flags.getValue()), this.divisibility);
    }
    /**
     * @internal
    ...
    toEmbeddedTransaction() {
        return new catbuffer_typescript_1.EmbeddedMosaicDefinitionTransactionBuilder(this.getSignerAsBuilder(), this.versionToDTO(), this.networkType.valueOf(), TransactionType_1.TransactionType.MOSAIC_DEFINITION.valueOf(), this.mosaicId.toBuilder(), new catbuffer_typescript_1.BlockDurationDto(this.duration.toDTO()), new catbuffer_typescript_1.MosaicNonceDto(this.getMosaicNonceIntValue()), catbuffer_typescript_1.GeneratorUtils.toFlags(catbuffer_typescript_1.MosaicFlagsDto, this.flags.getValue()), this.divisibility);
    }
    /**
     * @internal
     * @returns {MosaicDefinitionTransaction}
