...
class AccountOperationRestrictionTransaction extends Transaction_1.Transaction {
    ...
    toEmbeddedTransaction() {
        return new catbuffer_typescript_1.EmbeddedAccountOperationRestrictionTransactionBuilder(this.getSignerAsBuilder(), this.versionToDTO(), this.networkType.valueOf(), TransactionType_1.TransactionType.ACCOUNT_OPERATION_RESTRICTION.valueOf(), catbuffer_typescript_1.GeneratorUtils.toFlags(catbuffer_typescript_1.AccountRestrictionFlagsDto, this.restrictionFlags.valueOf()), this.restrictionAdditions, this.restrictionDeletions);
    }
    /**
     * @internal
     * @returns {AccountOperationRestrictionTransaction}
