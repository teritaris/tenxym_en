...
class AddressAliasTransaction extends Transaction_1.Transaction {
    ...
    toEmbeddedTransaction() {
        return new catbuffer_typescript_1.EmbeddedAddressAliasTransactionBuilder(this.getSignerAsBuilder(), this.versionToDTO(), this.networkType.valueOf(), TransactionType_1.TransactionType.ADDRESS_ALIAS.valueOf(), this.namespaceId.toBuilder(), this.address.toBuilder(), this.aliasAction.valueOf());
    }
    /**
     * @internal
     * @returns {AddressAliasTransaction}
