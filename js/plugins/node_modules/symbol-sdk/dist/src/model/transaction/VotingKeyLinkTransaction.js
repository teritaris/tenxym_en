...
class VotingKeyLinkTransaction extends Transaction_1.Transaction {
     ...
     */
    createBuilder() {
        return new catbuffer_typescript_1.VotingKeyLinkTransactionBuilder(this.getSignatureAsBuilder(), this.getSignerAsBuilder(), this.versionToDTO(), this.networkType.valueOf(), TransactionType_1.TransactionType.VOTING_KEY_LINK.valueOf(), new catbuffer_typescript_1.AmountDto(this.maxFee.toDTO()), new catbuffer_typescript_1.TimestampDto(this.deadline.toDTO()), new catbuffer_typescript_1.VotingPublicKeyDto(format_1.Convert.hexToUint8(this.linkedPublicKey)), new catbuffer_typescript_1.FinalizationEpochDto(this.startEpoch), new catbuffer_typescript_1.FinalizationEpochDto(this.endEpoch), this.linkAction.valueOf());
    }
    /**
     * @internal
