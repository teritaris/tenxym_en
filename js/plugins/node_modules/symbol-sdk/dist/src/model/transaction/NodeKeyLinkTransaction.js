...
exports.NodeKeyLinkTransaction = void 0;
...
class NodeKeyLinkTransaction extends Transaction_1.Transaction {
    ...
    toEmbeddedTransaction() {
        return new catbuffer_typescript_1.EmbeddedNodeKeyLinkTransactionBuilder(this.getSignerAsBuilder(), this.versionToDTO(), this.networkType.valueOf(), TransactionType_1.TransactionType.NODE_KEY_LINK.valueOf(), new catbuffer_typescript_1.PublicKeyDto(format_1.Convert.hexToUint8(this.linkedPublicKey)), this.linkAction.valueOf());
    }
    /**
     * @internal
     * @returns {NodeKeyLinkTransaction}
...
//# sourceMappingURL=NodeKeyLinkTransaction.js.map