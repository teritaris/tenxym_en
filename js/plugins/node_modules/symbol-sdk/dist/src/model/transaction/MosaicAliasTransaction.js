...
exports.MosaicAliasTransaction = void 0;
...
class MosaicAliasTransaction extends Transaction_1.Transaction {
    ...
    static createFromPayload(payload, isEmbedded = false) {
        ...
        const transaction = MosaicAliasTransaction.create(isEmbedded
            ...
            : Deadline_1.Deadline.createFromDTO(builder.getDeadline().timestamp), builder.getAliasAction().valueOf(), new NamespaceId_1.NamespaceId(builder.getNamespaceId().namespaceId), new MosaicId_1.MosaicId(builder.getMosaicId().mosaicId), networkType, isEmbedded ? new UInt64_1.UInt64([0, 0]) : new UInt64_1.UInt64(builder.fee.amount), signature, signerPublicKey.match(`^[0]+$`) ? undefined : PublicAccount_1.PublicAccount.createFromPublicKey(signerPublicKey, networkType));
     ...
     */
    createBuilder() {
        return new catbuffer_typescript_1.MosaicAliasTransactionBuilder(this.getSignatureAsBuilder(), this.getSignerAsBuilder(), this.versionToDTO(), this.networkType.valueOf(), TransactionType_1.TransactionType.MOSAIC_ALIAS.valueOf(), new catbuffer_typescript_1.AmountDto(this.maxFee.toDTO()), new catbuffer_typescript_1.TimestampDto(this.deadline.toDTO()), this.namespaceId.toBuilder(), this.mosaicId.toBuilder(), this.aliasAction.valueOf());
    }
    /**
     * @internal
    ...
    toEmbeddedTransaction() {
        return new catbuffer_typescript_1.EmbeddedMosaicAliasTransactionBuilder(this.getSignerAsBuilder(), this.versionToDTO(), this.networkType.valueOf(), TransactionType_1.TransactionType.MOSAIC_ALIAS.valueOf(), this.namespaceId.toBuilder(), this.mosaicId.toBuilder(), this.aliasAction.valueOf());
    }
    /**
     * @internal
     * @returns {MosaicAliasTransaction}
