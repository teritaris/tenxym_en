...
exports.AccountMosaicRestrictionTransaction = void 0;
...
class AccountMosaicRestrictionTransaction extends Transaction_1.Transaction {
    ...
    toEmbeddedTransaction() {
        return new catbuffer_typescript_1.EmbeddedAccountMosaicRestrictionTransactionBuilder(this.getSignerAsBuilder(), this.versionToDTO(), this.networkType.valueOf(), TransactionType_1.TransactionType.ACCOUNT_MOSAIC_RESTRICTION.valueOf(), catbuffer_typescript_1.GeneratorUtils.toFlags(catbuffer_typescript_1.AccountRestrictionFlagsDto, this.restrictionFlags.valueOf()), this.restrictionAdditions.map((addition) => {
            return new catbuffer_typescript_1.UnresolvedMosaicIdDto(addition.id.toDTO());
        }), this.restrictionDeletions.map((deletion) => {
            return new catbuffer_typescript_1.UnresolvedMosaicIdDto(deletion.id.toDTO());
        }));
