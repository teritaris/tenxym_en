...
class ArtifactExpiryReceipt extends Receipt_1.Receipt {
    ...
    serialize() {
        if (!this.artifactId.isNamespaceId()) {
            return new catbuffer_typescript_1.MosaicExpiryReceiptBuilder(ReceiptVersion_1.ReceiptVersion.ARTIFACT_EXPIRY, this.type.valueOf(), this.artifactId.toBuilder()).serialize();
        }
        return new catbuffer_typescript_1.NamespaceExpiryReceiptBuilder(ReceiptVersion_1.ReceiptVersion.ARTIFACT_EXPIRY, this.type.valueOf(), this.artifactId.toBuilder()).serialize();
    }
}
