...
class HashLockHttp extends Http_1.Http {
     ...
     */
    toHashLockInfo(dto) {
        return new HashLockInfo_1.HashLockInfo(dto.lock.version || 1, dto.id, DtoMapping_1.DtoMapping.toAddress(dto.lock.ownerAddress), new MosaicId_1.MosaicId(dto.lock.mosaicId), UInt64_1.UInt64.fromNumericString(dto.lock.amount), UInt64_1.UInt64.fromNumericString(dto.lock.endHeight), dto.lock.status.valueOf(), dto.lock.hash);
    }
}
