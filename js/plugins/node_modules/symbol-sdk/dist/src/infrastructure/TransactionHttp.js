...
class TransactionHttp extends Http_1.Http {
    ...
    getTransactionEffectiveFee(transactionId) {
        return this.call(this.getTransactionByGroup(transactionId, TransactionGroup_1.TransactionGroup.Confirmed), transaction_2.CreateTransactionFromDTO).pipe(operators_1.mergeMap((transaction) => {
