...
class RepositoryFactoryHttp {
    ...
    constructor(url, configs) {
        ...
        this.networkType = (configs === null || configs === void 0 ? void 0 : configs.networkType) ? rxjs_1.of(configs.networkType) : this.cache(() => networkRepository.getNetworkType());
        this.networkProperties = this.cache(() => networkRepository.getNetworkProperties());
        this.epochAdjustment = (configs === null || configs === void 0 ? void 0 : configs.epochAdjustment) ? rxjs_1.of(configs.epochAdjustment)
            : this.cache(() => this.networkProperties.pipe(operators_1.map((property) => {
                var _a;
        ...
        if ((configs === null || configs === void 0 ? void 0 : configs.generationHash) && (configs === null || configs === void 0 ? void 0 : configs.nodePublicKey)) {
            this.generationHash = rxjs_1.of(configs.generationHash);
            this.nodePublicKey = rxjs_1.of(configs.nodePublicKey);
        }
        else {
            const nodeInfoObservable = this.cache(() => this.createNodeRepository().getNodeInfo());
            this.generationHash = rxjs_1.defer(() => nodeInfoObservable.pipe(operators_1.map((b) => b.networkGenerationHashSeed)));
            this.nodePublicKey = rxjs_1.defer(() => nodeInfoObservable.pipe(operators_1.map((b) => b.nodePublicKey)));
        }
        ...
        this.networkCurrencies = (configs === null || configs === void 0 ? void 0 : configs.networkCurrencies) ? rxjs_1.of(configs.networkCurrencies)
            : this.cache(() => new CurrencyService_1.CurrencyService(this).getNetworkCurrencies());
    }
    cache(delegate) {
        return rxjs_1.defer(delegate).pipe(operators_1.shareReplay(1));
    }
