...
class SecretLockHttp extends Http_1.Http {
    ...
    toSecretLockInfo(dto) {
        return new lock_1.SecretLockInfo(dto.lock.version || 1, dto.id, utils_1.DtoMapping.toAddress(dto.lock.ownerAddress), new mosaic_1.MosaicId(dto.lock.mosaicId), model_1.UInt64.fromNumericString(dto.lock.amount), model_1.UInt64.fromNumericString(dto.lock.endHeight), dto.lock.status.valueOf(), dto.lock.hashAlgorithm.valueOf(), dto.lock.secret, utils_1.DtoMapping.toAddress(dto.lock.recipientAddress), dto.lock.compositeHash);
    }
}
