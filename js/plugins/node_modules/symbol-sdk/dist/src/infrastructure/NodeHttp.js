...
class NodeHttp extends Http_1.Http {
    ...
    getServerInfo() {
        return this.call(this.nodeRoutesApi.getServerInfo(), (body) => {
            var _a;
            return new node_1.ServerInfo(body.serverInfo.restVersion, body.serverInfo.sdkVersion, ((_a = body.serverInfo) === null || _a === void 0 ? void 0 : _a.deployment) ? new Deployment_1.Deployment(body.serverInfo.deployment.deploymentTool, body.serverInfo.deployment.deploymentToolVersion, body.serverInfo.deployment.lastUpdatedDate)
                : undefined);
        });
    }
    /**
