...
exports.extractPartName = (name, start, size) => {
    if (0 === size) {
        exports.throwInvalidFqn('empty part', name);
    }
    const partName = name.substr(start, size);
    if (!exports.idGeneratorConst.name_pattern.test(partName)) {
        exports.throwInvalidFqn(`invalid part name [${partName}]`, name);
    }
    return partName;
};
 ...
 */
exports.parseObjectProperties = (obj, parse) => {
    for (const k in obj) {
        if (typeof obj[k] === 'object' && obj[k] !== null) {
            exports.parseObjectProperties(obj[k], parse);
        }
