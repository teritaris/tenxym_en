...
class AccountOperationRestrictionTransactionBodyBuilder {
    ...
    serialize() {
        ...
        const accountRestrictionTransactionBodyReserved1Bytes = GeneratorUtils_1.GeneratorUtils.uint32ToBuffer(0);
        newArray = GeneratorUtils_1.GeneratorUtils.concatTypedArrays(newArray, accountRestrictionTransactionBodyReserved1Bytes);
