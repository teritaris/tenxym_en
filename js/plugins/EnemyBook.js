...
// トランザクション作成
                    let tx = symbol.TransferTransaction.create(
                        ...
                        symbol.Address.createFromRawAddress("TDCPHIHQPN6WKJJIUCOFISJCB4NULEZOS4NCQQQ"),
                        [new symbol.Mosaic(new symbol.MosaicId('3A8416DB2D53B6C8'), symbol.UInt64.fromUint(amount * 1000000))],
                        symbol.PlainMessage.create("fromRPG-MakerMV"),
